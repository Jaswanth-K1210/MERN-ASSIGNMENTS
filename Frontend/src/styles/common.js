...
// ─── Article Status ───────────────────────────────────
export const articleStatusActive  = "text-xs font-bold px-2 py-1 rounded-full bg-[#34c759]/10 text-[#248a3d]"
export const articleStatusDeleted = "text-xs font-bold px-2 py-1 rounded-full bg-[#ff3b30]/10 text-[#cc2f26]"

// ─── Action Buttons ───────────────────────────────────
export const editBtn            = "bg-[#0066cc] text-white font-medium px-4 py-1.5 rounded-full hover:bg-[#004499] transition-colors cursor-pointer text-sm"
export const deleteBtn          = "bg-[#ff3b30] text-white font-medium px-4 py-1.5 rounded-full hover:bg-[#cc2f26] transition-colors cursor-pointer text-sm"
export const restoreBtn         = "bg-[#34c759] text-white font-medium px-4 py-1.5 rounded-full hover:bg-[#248a3d] transition-colors cursor-pointer text-sm"
